...
% that's been planned throught the given map.
%
% parameters:
%   start : a 1x3 vector with the start position of the quad
%   stop  : a 1x3 vector with the goal position of the quad
%   map   : map generated by the load_map
%   path  : an nx3 matrix path planned by your dijkstra/A* algorithm
...
for qn = 1:nquad
    ...
    x0{qn}    = init_state(start{qn}, eye(3));
